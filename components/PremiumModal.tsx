    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in">
      <div className="bg-background-secondary border border-surface rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
        ...
        <div className="p-8 pb-4 text-center relative">
          ...
          <h2 className="text-3xl font-black text-text-primary mb-2">Refill Your TradeLens Points</h2>
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
           {PREMIUM_PACKAGES.map((pkg) => (
             <div 
               key={pkg.id} 
               className={`relative flex flex-col p-6 rounded-xl border-2 transition-all duration-300 hover:transform hover:-translate-y-1 ${
                 pkg.isPopular 
             ...
             >
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-lg font-bold transition-all relative overflow-hidden ${
                    pkg.isPopular 
